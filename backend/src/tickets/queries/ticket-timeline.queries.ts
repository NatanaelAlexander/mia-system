...
/**
 * Timeline scoped to tickets of companies linked to the portal user.
 *
 * Params: $1 trunc unit, $2 start timestamptz, $3 interval, $4 actorUserId
 */
export const SQL_TICKET_TIMELINE_FOR_PORTAL_USER = `
  WITH buckets AS (
    SELECT gs AS bucket
    FROM generate_series(
      date_trunc($1, ($2::timestamptz AT TIME ZONE 'UTC')),
